        ...
        for (var i = 0; i < this.files.length; i++) {
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#upload-img-show').append('<img class="lazyload upload-image-preview" src="https://cdn.jsdelivr.net/gh/hellozjx/wpsource@1.0.1/img/svg/loader/trans.ajax-spinner-preloader.svg" data-src="' + get_the_url + '" onclick="window.open(\'' + get_the_url + '\')" onerror="imgError(this)" />');
                    lazyload();
...
$(document).ready(function () {
    ...
    $(".skin-menu #dark-bg").click(function () {
        mashiro_global.variables.skinSecter = true;
        mashiro_global.variables.isNight = true;
        $("body").css("background-image", "url(https://cdn.jsdelivr.net/gh/hellozjx/wpsource@1.0.1/other-sites/api-index/images/me.png)");
...
function changeFont() {
    if (currentFontIsUbuntu) {
        loadCSS("https://cdn.jsdelivr.net/gh/hellozjx/wpsource@1.0.1/css/cn.css");
        currentFontIsUbuntu = false;
    } else {
        loadCSS("https://cdn.jsdelivr.net/gh/hellozjx/wpsource@1.0.1/css/or.css");
...
function convertChinese(zh) {
    if (zh == 'cn') {
        ...
        loadCSS("https://cdn.jsdelivr.net/gh/hellozjx/wpsource@1.0.1/css/tw.css");
    }
    if (zh == 'tw') {
        ...
        NH: function () {
            var h1 = 0,
				...
				$(".site-header").hover(function(){
					...
					{
						$(".line").css("background-color","#666");
						$(".faa-shake").attr("src","./wp-content/themes/Sakura/images/none.png");
					}
				},function(){
					if($(document).scrollTop()==0)
					{
						$(".line").css("background-color","#fff");
						$(".faa-shake").attr("src","./wp-content/themes/Sakura/images/none_white.png");
					}
				});
            $(window).scroll(function () {
                ...
                if (s == h1) {
					...
					$('.site-name').removeClass('dark_style');
					$('.js-toggle-search').removeClass('dark_style');
					$('.line').css('background','#fff');
					$(".faa-shake").attr("src","./wp-content/themes/Sakura/images/none_white.png");
                }
                if (s > h1) {
                    $('.site-header').addClass('yya');
					$('.site-name').addClass('dark_style');
					$('.js-toggle-search').addClass('dark_style');
					$('.line').css('background','#666');
					$(".faa-shake").attr("src","./wp-content/themes/Sakura/images/none.png");
                }
                if (s > h2) {
